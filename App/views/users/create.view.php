...
<?php endif; ?>
    <form method="POST" action="/byblios/auth/register">
      <div class="mb-4">
      ...
      <div class="mb-4">
        <input type="text" name="city" placeholder="Address/Street" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $user['city'] ?? '' ?>" />
      </div>
      <div class="mb-4">
        <input type="text" name="state" placeholder="City" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $user['state'] ?? '' ?>" />
      </div>
      <div class="mb-4">
      ...
      <p class="mt-4 text-gray-500">
        ...
        <a class="text-blue-900" href="/byblios/auth/login">Login</a>
      </p>
    </form>
  </div>
</div>
